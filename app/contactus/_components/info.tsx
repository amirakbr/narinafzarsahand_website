  ...
  return (
    <div className="flex flex-col gap-8">
      ...
      <div className="flex flex-col gap-2">
        <p className="text-slate-500 text-base xl:text-2xl">آدرس</p>
        <div className="flex flex-col gap-2 border border-slate-500 rounded p-2">
          <p className="text-slate-500 font-medium text-xs xl:text-sm text-justify">
          ...
          <p className="text-slate-500 font-medium text-xs xl:text-sm text-justify">
            نشانی تبـریـز: خیابان شهید مدرس ، خیابان شهید بهشتی ، مجتمع اداری
            عتیق2 ، طبقه 3 واحد 337 کدپستی: 5136944410
          </p>
        </div>
      </div>
    </div>
