...
شنیده شود و رشد شغلی واقعی را تجربه کنید، جای شما در تیم ما خالی است!"
          />
          <h4 className="text-right font-bold text-lg lg:text-3xl text-[#4249d8] my-4">
          ...
          <hr className="text-[#4249d8] w-2/3 mt-16 h-1" />
          <h4 className="text-right font-bold text-lg lg:text-3xl text-[#4249d8] my-8">
