...
const Terminals = ({ terminalData }: ITerminalProps) => {
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 items-center justify-center gap-4">
      {terminalData.map(({ imageUrl, label }, index) => (
        ...
        >
          <div className="rounded-lg overflow-hidden">
            <div className="scale-100 group-hover:scale-140 transition-all duration-[3s] ease-linear h-96 sm:h-84 md:h-64">
              <Image
                alt={label}
                src={imageUrl}
                width={1000}
